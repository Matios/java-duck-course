...
//In this assignment you will create a new class named FirstRatings to process the movie 
//and ratings data and to answer questions about them. You may find it helpful to use 
//CSVParser and CSVRecord. Note that FirstRatings will need the following three import statements:
 ...
 */
	...
	public ArrayList<PlainRater> loadRater(String filename){
	...
	public void testLoadRaters() {
		...
		ArrayList<PlainRater> raters = loadRater(fileName);
